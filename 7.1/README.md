...
Mount your existing Laravel installation to /var/www
    ...
    docker run -p 8080:80 -p 8443:443 -v /home/user/code/laravel:/var/www -d fivestartechnology/laravel-php-docker:7.1
...
services:
    ...
    web:
        image: fivestartechnology/laravel-php-docker:7.1
        depends_on:
            - db
            - redis
        links:
